...
//	daftarkan even onClick pada btnSimpan ton1.setOnClickListener(new View.OnClickListener() {

        ton1.setOnClickListener(new View.OnClickListener() { @Override
...
//	TODO Auto-generated method stub
    //Update username dan password
            ...
            db.execSQL("update user set password='"+text2.getText().toString() +"'where username='" +
            ...
            Intent i = new Intent(getApplicationContext(),MainActivity.class); //Berpindah ke MainActivity.class
            startActivity(i);
        }
